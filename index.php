  ...
  <body>
   ...
   <?php
    ...
    $nama2 = 'Materi PHP Pemula - Tipe Data Dan String(Materi 4)';
     ...
     echo "<h1>$nama2</h1>";
    echo "Selamat datang di Adineno koding"; 
   ?>
  </body>
</html>
